...
class ModelsApi
{
    ...
    public function getOrganizationSummaryTopDevicesModelsByUsageRequest($organization_id, $network_tag = null, $device_tag = null, $quantity = null, $ssid_name = null, $usage_uplink = null, $t0 = null, $t1 = null, $timespan = null, string $contentType = self::contentTypes['getOrganizationSummaryTopDevicesModelsByUsage'][0])
    {
        ...
        if ($timespan !== null && $timespan > 16070400) {
            throw new \InvalidArgumentException('invalid value for "$timespan" when calling ModelsApi.getOrganizationSummaryTopDevicesModelsByUsage, must be smaller than or equal to 16070400.');
        }
        if ($timespan !== null && $timespan < 28800) {
            throw new \InvalidArgumentException('invalid value for "$timespan" when calling ModelsApi.getOrganizationSummaryTopDevicesModelsByUsage, must be bigger than or equal to 28800.');
        }
