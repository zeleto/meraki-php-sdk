...
/**
 * ByUtilizationApi Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
...
class ByUtilizationApi
{
    ...
    public function getOrganizationSummaryTopAppliancesByUtilizationRequest($organization_id, $network_tag = null, $device_tag = null, $quantity = null, $ssid_name = null, $usage_uplink = null, $t0 = null, $t1 = null, $timespan = null, string $contentType = self::contentTypes['getOrganizationSummaryTopAppliancesByUtilization'][0])
    {
        ...
        if ($timespan !== null && $timespan > 16070400) {
            throw new \InvalidArgumentException('invalid value for "$timespan" when calling ByUtilizationApi.getOrganizationSummaryTopAppliancesByUtilization, must be smaller than or equal to 16070400.');
        }
        if ($timespan !== null && $timespan < 1500) {
            throw new \InvalidArgumentException('invalid value for "$timespan" when calling ByUtilizationApi.getOrganizationSummaryTopAppliancesByUtilization, must be bigger than or equal to 1500.');
        }
