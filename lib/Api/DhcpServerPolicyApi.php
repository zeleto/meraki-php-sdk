...
class DhcpServerPolicyApi
{
     ...
     *
     * @param  string $network_id Network ID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getNetworkSwitchDhcpServerPolicy'] to see the possible values for this operation
     *
     * @throws \Meraki\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Meraki\Model\GetNetworkSwitchDhcpServerPolicy200Response
     */
    public function getNetworkSwitchDhcpServerPolicy($network_id, string $contentType = self::contentTypes['getNetworkSwitchDhcpServerPolicy'][0])
    {
        list($response) = $this->getNetworkSwitchDhcpServerPolicyWithHttpInfo($network_id, $contentType);
        return $response;
    }
     ...
     * @throws \Meraki\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Meraki\Model\GetNetworkSwitchDhcpServerPolicy200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getNetworkSwitchDhcpServerPolicyWithHttpInfo($network_id, string $contentType = self::contentTypes['getNetworkSwitchDhcpServerPolicy'][0])
    {
        $request = $this->getNetworkSwitchDhcpServerPolicyRequest($network_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Meraki\Model\GetNetworkSwitchDhcpServerPolicy200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Meraki\Model\GetNetworkSwitchDhcpServerPolicy200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Meraki\Model\GetNetworkSwitchDhcpServerPolicy200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\Meraki\Model\GetNetworkSwitchDhcpServerPolicy200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Meraki\Model\GetNetworkSwitchDhcpServerPolicy200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getNetworkSwitchDhcpServerPolicyAsync($network_id, string $contentType = self::contentTypes['getNetworkSwitchDhcpServerPolicy'][0])
    {
        return $this->getNetworkSwitchDhcpServerPolicyAsyncWithHttpInfo($network_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getNetworkSwitchDhcpServerPolicyAsyncWithHttpInfo($network_id, string $contentType = self::contentTypes['getNetworkSwitchDhcpServerPolicy'][0])
    {
        $returnType = '\Meraki\Model\GetNetworkSwitchDhcpServerPolicy200Response';
        $request = $this->getNetworkSwitchDhcpServerPolicyRequest($network_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getNetworkSwitchDhcpServerPolicyRequest($network_id, string $contentType = self::contentTypes['getNetworkSwitchDhcpServerPolicy'][0])
    {
     ...
     *
     * @param  string $network_id Network ID (required)
     * @param  \Meraki\Model\UpdateNetworkSwitchDhcpServerPolicyRequest|null $update_network_switch_dhcp_server_policy_request update_network_switch_dhcp_server_policy_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateNetworkSwitchDhcpServerPolicy'] to see the possible values for this operation
     *
     * @throws \Meraki\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Meraki\Model\GetNetworkSwitchDhcpServerPolicy200Response
     */
    public function updateNetworkSwitchDhcpServerPolicy($network_id, $update_network_switch_dhcp_server_policy_request = null, string $contentType = self::contentTypes['updateNetworkSwitchDhcpServerPolicy'][0])
    {
        list($response) = $this->updateNetworkSwitchDhcpServerPolicyWithHttpInfo($network_id, $update_network_switch_dhcp_server_policy_request, $contentType);
        return $response;
    }
     ...
     *
     * @param  string $network_id Network ID (required)
     * @param  \Meraki\Model\UpdateNetworkSwitchDhcpServerPolicyRequest|null $update_network_switch_dhcp_server_policy_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateNetworkSwitchDhcpServerPolicy'] to see the possible values for this operation
     *
     * @throws \Meraki\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Meraki\Model\GetNetworkSwitchDhcpServerPolicy200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateNetworkSwitchDhcpServerPolicyWithHttpInfo($network_id, $update_network_switch_dhcp_server_policy_request = null, string $contentType = self::contentTypes['updateNetworkSwitchDhcpServerPolicy'][0])
    {
        $request = $this->updateNetworkSwitchDhcpServerPolicyRequest($network_id, $update_network_switch_dhcp_server_policy_request, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateNetworkSwitchDhcpServerPolicyAsync($network_id, $update_network_switch_dhcp_server_policy_request = null, string $contentType = self::contentTypes['updateNetworkSwitchDhcpServerPolicy'][0])
    {
        return $this->updateNetworkSwitchDhcpServerPolicyAsyncWithHttpInfo($network_id, $update_network_switch_dhcp_server_policy_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateNetworkSwitchDhcpServerPolicyAsyncWithHttpInfo($network_id, $update_network_switch_dhcp_server_policy_request = null, string $contentType = self::contentTypes['updateNetworkSwitchDhcpServerPolicy'][0])
    {
        $returnType = '\Meraki\Model\GetNetworkSwitchDhcpServerPolicy200Response';
        $request = $this->updateNetworkSwitchDhcpServerPolicyRequest($network_id, $update_network_switch_dhcp_server_policy_request, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateNetworkSwitchDhcpServerPolicyRequest($network_id, $update_network_switch_dhcp_server_policy_request = null, string $contentType = self::contentTypes['updateNetworkSwitchDhcpServerPolicy'][0])
    {
        ...
        // for model (json/xml)
        if (isset($update_network_switch_dhcp_server_policy_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($update_network_switch_dhcp_server_policy_request));
            } else {
                $httpBody = $update_network_switch_dhcp_server_policy_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
