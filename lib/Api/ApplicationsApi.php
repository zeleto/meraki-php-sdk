...
class ApplicationsApi
{
    ...
    public function getNetworkInsightApplicationHealthByTimeRequest($network_id, $application_id, $t0 = null, $t1 = null, $timespan = null, $resolution = null, string $contentType = self::contentTypes['getNetworkInsightApplicationHealthByTime'][0])
    {
        ...
        if ($timespan !== null && $timespan > 604800) {
            throw new \InvalidArgumentException('invalid value for "$timespan" when calling ApplicationsApi.getNetworkInsightApplicationHealthByTime, must be smaller than or equal to 604800.');
        }
    ...
    public function getOrganizationSummaryTopApplicationsByUsageRequest($organization_id, $network_tag = null, $device = null, $network_id = null, $quantity = null, $ssid_name = null, $usage_uplink = null, $t0 = null, $t1 = null, $timespan = null, string $contentType = self::contentTypes['getOrganizationSummaryTopApplicationsByUsage'][0])
    {
        ...
        if ($timespan !== null && $timespan > 16070400) {
            throw new \InvalidArgumentException('invalid value for "$timespan" when calling ApplicationsApi.getOrganizationSummaryTopApplicationsByUsage, must be smaller than or equal to 16070400.');
        }
        if ($timespan !== null && $timespan < 1500) {
            throw new \InvalidArgumentException('invalid value for "$timespan" when calling ApplicationsApi.getOrganizationSummaryTopApplicationsByUsage, must be bigger than or equal to 1500.');
        }
    ...
    public function getOrganizationSummaryTopApplicationsCategoriesByUsageRequest($organization_id, $network_tag = null, $device_tag = null, $network_id = null, $quantity = null, $ssid_name = null, $usage_uplink = null, $t0 = null, $t1 = null, $timespan = null, string $contentType = self::contentTypes['getOrganizationSummaryTopApplicationsCategoriesByUsage'][0])
    {
        ...
        if ($timespan !== null && $timespan > 16070400) {
            throw new \InvalidArgumentException('invalid value for "$timespan" when calling ApplicationsApi.getOrganizationSummaryTopApplicationsCategoriesByUsage, must be smaller than or equal to 16070400.');
        }
        if ($timespan !== null && $timespan < 1500) {
            throw new \InvalidArgumentException('invalid value for "$timespan" when calling ApplicationsApi.getOrganizationSummaryTopApplicationsCategoriesByUsage, must be bigger than or equal to 1500.');
        }
