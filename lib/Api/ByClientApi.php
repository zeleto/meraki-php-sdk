...
class ByClientApi
{
    ...
    public function getNetworkPoliciesByClientRequest($network_id, $per_page = null, $starting_after = null, $ending_before = null, $t0 = null, $timespan = null, string $contentType = self::contentTypes['getNetworkPoliciesByClient'][0])
    {
        ...
        if ($timespan !== null && $timespan > 2678400) {
            throw new \InvalidArgumentException('invalid value for "$timespan" when calling ByClientApi.getNetworkPoliciesByClient, must be smaller than or equal to 2678400.');
        }
    ...
    public function getOrganizationWirelessDevicesPacketLossByClientRequest($organization_id, $network_ids = null, $ssids = null, $bands = null, $macs = null, $per_page = null, $starting_after = null, $ending_before = null, $t0 = null, $t1 = null, $timespan = null, string $contentType = self::contentTypes['getOrganizationWirelessDevicesPacketLossByClient'][0])
    {
        ...
        if ($timespan !== null && $timespan > 7776000) {
            throw new \InvalidArgumentException('invalid value for "$timespan" when calling ByClientApi.getOrganizationWirelessDevicesPacketLossByClient, must be smaller than or equal to 7776000.');
        }
        if ($timespan !== null && $timespan < 300) {
            throw new \InvalidArgumentException('invalid value for "$timespan" when calling ByClientApi.getOrganizationWirelessDevicesPacketLossByClient, must be bigger than or equal to 300.');
        }
