...
class PerformanceApi
{
    ...
    public function getDeviceAppliancePerformanceRequest($serial, $t0 = null, $t1 = null, $timespan = null, string $contentType = self::contentTypes['getDeviceAppliancePerformance'][0])
    {
        ...
        if ($timespan !== null && $timespan > 1209600) {
            throw new \InvalidArgumentException('invalid value for "$timespan" when calling PerformanceApi.getDeviceAppliancePerformance, must be smaller than or equal to 1209600.');
        }
        if ($timespan !== null && $timespan < 1800) {
            throw new \InvalidArgumentException('invalid value for "$timespan" when calling PerformanceApi.getDeviceAppliancePerformance, must be bigger than or equal to 1800.');
        }
