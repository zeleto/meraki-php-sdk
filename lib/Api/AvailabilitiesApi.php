...
class AvailabilitiesApi
{
    ...
    public function getOrganizationDevicesAvailabilitiesChangeHistoryRequest($organization_id, $per_page = null, $starting_after = null, $ending_before = null, $t0 = null, $t1 = null, $timespan = null, $serials = null, $product_types = null, $network_ids = null, $statuses = null, string $contentType = self::contentTypes['getOrganizationDevicesAvailabilitiesChangeHistory'][0])
    {
        ...
        if ($timespan !== null && $timespan > 2678400) {
            throw new \InvalidArgumentException('invalid value for "$timespan" when calling AvailabilitiesApi.getOrganizationDevicesAvailabilitiesChangeHistory, must be smaller than or equal to 2678400.');
        }
    ...
    public function getOrganizationWirelessControllerAvailabilitiesChangeHistoryRequest($organization_id, $serials = null, $t0 = null, $t1 = null, $timespan = null, $per_page = null, $starting_after = null, $ending_before = null, string $contentType = self::contentTypes['getOrganizationWirelessControllerAvailabilitiesChangeHistory'][0])
    {
        ...
        if ($timespan !== null && $timespan > 2678400) {
            throw new \InvalidArgumentException('invalid value for "$timespan" when calling AvailabilitiesApi.getOrganizationWirelessControllerAvailabilitiesChangeHistory, must be smaller than or equal to 2678400.');
        }
