...
/**
 * PacketLossApi Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
...
class PacketLossApi
{
    ...
    public function getOrganizationWirelessDevicesPacketLossByClientRequest($organization_id, $network_ids = null, $ssids = null, $bands = null, $macs = null, $per_page = null, $starting_after = null, $ending_before = null, $t0 = null, $t1 = null, $timespan = null, string $contentType = self::contentTypes['getOrganizationWirelessDevicesPacketLossByClient'][0])
    {
        ...
        if ($timespan !== null && $timespan > 7776000) {
            throw new \InvalidArgumentException('invalid value for "$timespan" when calling PacketLossApi.getOrganizationWirelessDevicesPacketLossByClient, must be smaller than or equal to 7776000.');
        }
        if ($timespan !== null && $timespan < 300) {
            throw new \InvalidArgumentException('invalid value for "$timespan" when calling PacketLossApi.getOrganizationWirelessDevicesPacketLossByClient, must be bigger than or equal to 300.');
        }
    ...
    public function getOrganizationWirelessDevicesPacketLossByDeviceRequest($organization_id, $network_ids = null, $serials = null, $ssids = null, $bands = null, $per_page = null, $starting_after = null, $ending_before = null, $t0 = null, $t1 = null, $timespan = null, string $contentType = self::contentTypes['getOrganizationWirelessDevicesPacketLossByDevice'][0])
    {
        ...
        if ($timespan !== null && $timespan > 7776000) {
            throw new \InvalidArgumentException('invalid value for "$timespan" when calling PacketLossApi.getOrganizationWirelessDevicesPacketLossByDevice, must be smaller than or equal to 7776000.');
        }
        if ($timespan !== null && $timespan < 300) {
            throw new \InvalidArgumentException('invalid value for "$timespan" when calling PacketLossApi.getOrganizationWirelessDevicesPacketLossByDevice, must be bigger than or equal to 300.');
        }
    ...
    public function getOrganizationWirelessDevicesPacketLossByNetworkRequest($organization_id, $network_ids = null, $serials = null, $ssids = null, $bands = null, $per_page = null, $starting_after = null, $ending_before = null, $t0 = null, $t1 = null, $timespan = null, string $contentType = self::contentTypes['getOrganizationWirelessDevicesPacketLossByNetwork'][0])
    {
        ...
        if ($timespan !== null && $timespan > 7776000) {
            throw new \InvalidArgumentException('invalid value for "$timespan" when calling PacketLossApi.getOrganizationWirelessDevicesPacketLossByNetwork, must be smaller than or equal to 7776000.');
        }
        if ($timespan !== null && $timespan < 300) {
            throw new \InvalidArgumentException('invalid value for "$timespan" when calling PacketLossApi.getOrganizationWirelessDevicesPacketLossByNetwork, must be bigger than or equal to 300.');
        }
