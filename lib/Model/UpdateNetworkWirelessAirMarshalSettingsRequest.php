<?php
/**
 * UpdateNetworkWirelessAirMarshalSettingsRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * UpdateNetworkWirelessAirMarshalSettingsRequest Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class UpdateNetworkWirelessAirMarshalSettingsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateNetworkWirelessAirMarshalSettings_request';
    ...
    */
     ...
     * Sets default_policy
     *
     * @param string $default_policy Allows clients to access rogue networks. Blocked by default.
     *
     * @return self
     */
