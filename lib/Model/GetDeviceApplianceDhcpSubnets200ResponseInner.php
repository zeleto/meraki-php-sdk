<?php
/**
 * GetDeviceApplianceDhcpSubnets200ResponseInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetDeviceApplianceDhcpSubnets200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class GetDeviceApplianceDhcpSubnets200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getDeviceApplianceDhcpSubnets_200_response_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('free_count', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets used_count
     *
     * @param int|null $used_count Count of used IP addresses in subnet
     *
     * @return self
     */
     ...
     * Sets free_count
     *
     * @param int|null $free_count Count of free IP addresses in subnet
     *
     * @return self
     */
    public function setFreeCount($free_count)
    {
        if (is_null($free_count)) {
            throw new \InvalidArgumentException('non-nullable free_count cannot be null');
        }
