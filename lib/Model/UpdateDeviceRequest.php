...
class UpdateDeviceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('move_map_marker', $data ?? [], null);
        $this->setIfExists('switch_profile_id', $data ?? [], null);
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The name of a device
     *
     * @return self
     */
     ...
     * Sets tags
     *
     * @param string[]|null $tags The list of tags of a device
     *
     * @return self
     */
     ...
     * Sets lat
     *
     * @param float|null $lat The latitude of a device
     *
     * @return self
     */
     ...
     * Sets lng
     *
     * @param float|null $lng The longitude of a device
     *
     * @return self
     */
     ...
     * Sets address
     *
     * @param string|null $address The address of a device
     *
     * @return self
     */
     ...
     * Sets notes
     *
     * @param string|null $notes The notes for the device. String. Limited to 255 characters.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $move_map_marker Whether or not to set the latitude and longitude of a device based on the new address. Only applies when lat and lng are not specified.
     *
     * @return self
     */
    public function setMoveMapMarker($move_map_marker)
    {
        if (is_null($move_map_marker)) {
            throw new \InvalidArgumentException('non-nullable move_map_marker cannot be null');
        }
     ...
     *
     * @param string|null $switch_profile_id The ID of a switch template to bind to the device (for available switch templates, see the 'Switch Templates' endpoint). Use null to unbind the switch device from the current profile. For a device to be bindable to a switch template, it must (1) be a switch, and (2) belong to a network that is bound to a configuration template.
     *
     * @return self
     */
    public function setSwitchProfileId($switch_profile_id)
    {
        if (is_null($switch_profile_id)) {
            throw new \InvalidArgumentException('non-nullable switch_profile_id cannot be null');
        }
     ...
     * Sets floor_plan_id
     *
     * @param string|null $floor_plan_id The floor plan to associate to this device. null disassociates the device from the floorplan.
     *
     * @return self
     */
