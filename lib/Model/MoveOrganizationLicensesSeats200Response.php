...
/**
 * MoveOrganizationLicensesSeats200Response Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class MoveOrganizationLicensesSeats200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'moveOrganizationLicensesSeats_200_response';
    ...
    {
        $this->setIfExists('dest_organization_id', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $dest_organization_id The ID of the organization to move the SM seats to
     *
     * @return self
     */
    public function setDestOrganizationId($dest_organization_id)
    {
        if (is_null($dest_organization_id)) {
            throw new \InvalidArgumentException('non-nullable dest_organization_id cannot be null');
        }
     ...
     * Sets license_id
     *
     * @param string|null $license_id The ID of the SM license to move the seats from
     *
     * @return self
     */
     ...
     * Sets seat_count
     *
     * @param int|null $seat_count The number of seats to move to the new organization. Must be less than or equal to the total number of seats of the license
     *
     * @return self
     */
