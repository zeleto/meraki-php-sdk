<?php
/**
 * GetOrganizationSummaryTopApplicationsByUsage200ResponseInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetOrganizationSummaryTopApplicationsByUsage200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class GetOrganizationSummaryTopApplicationsByUsage200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getOrganizationSummaryTopApplicationsByUsage_200_response_inner';
    ...
    */
     ...
     * Sets application
     *
     * @param string|null $application Name of the Application
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param float|null $total Total usage of the Application, in megabytes
     *
     * @return self
     */
     ...
     * Sets downstream
     *
     * @param float|null $downstream Downstream usage of the Application, in megabytes
     *
     * @return self
     */
     ...
     * Sets upstream
     *
     * @param float|null $upstream Upstream usage of the Application, in megabytes
     *
     * @return self
     */
     ...
     * Sets percentage
     *
     * @param float|null $percentage Percent usage of the Application
     *
     * @return self
     */
