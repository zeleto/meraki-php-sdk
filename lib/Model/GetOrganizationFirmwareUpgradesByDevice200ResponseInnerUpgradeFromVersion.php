...
/**
 * GetOrganizationFirmwareUpgradesByDevice200ResponseInnerUpgradeFromVersion Class Doc Comment
 *
 * @category Class
 ...
 */
class GetOrganizationFirmwareUpgradesByDevice200ResponseInnerUpgradeFromVersion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getOrganizationFirmwareUpgradesByDevice_200_response_inner_upgrade_fromVersion';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id ID of the initial firmware version
     *
     * @return self
     */
     ...
     * Sets release_date
     *
     * @param string|null $release_date Release date of the firmware version
     *
     * @return self
     */
