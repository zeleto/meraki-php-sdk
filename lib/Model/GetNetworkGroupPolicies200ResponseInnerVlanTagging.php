...
/**
 * GetNetworkGroupPolicies200ResponseInnerVlanTagging Class Doc Comment
 *
 * @category Class
 ...
 */
class GetNetworkGroupPolicies200ResponseInnerVlanTagging implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getNetworkGroupPolicies_200_response_inner_vlanTagging';
    ...
    */
     ...
     * Sets settings
     *
     * @param string|null $settings How VLAN tagging is applied. Can be 'network default', 'ignore' or 'custom'.
     *
     * @return self
     */
     ...
     * Sets vlan_id
     *
     * @param string|null $vlan_id The ID of the vlan you want to tag. This only applies if 'settings' is set to 'custom'.
     *
     * @return self
     */
