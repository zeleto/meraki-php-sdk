...
/**
 * GetOrganizationSummaryTopSsidsByUsage200ResponseInnerUsage Class Doc Comment
 *
 * @category Class
 ...
 */
class GetOrganizationSummaryTopSsidsByUsage200ResponseInnerUsage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getOrganizationSummaryTopSsidsByUsage_200_response_inner_usage';
    ...
    */
     ...
     * Sets total
     *
     * @param float|null $total Total usage of the SSID
     *
     * @return self
     */
     ...
     * Sets downstream
     *
     * @param float|null $downstream Downstream usage of the SSID
     *
     * @return self
     */
     ...
     * Sets upstream
     *
     * @param float|null $upstream Upstream usage of the SSID
     *
     * @return self
     */
     ...
     * Sets percentage
     *
     * @param float|null $percentage Percentage usage of the SSID
     *
     * @return self
     */
