...
/**
 * UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateNetworkSwitchStackRoutingInterfaceDhcp_request';
    ...
    */
     ...
     * Sets dhcp_mode
     *
     * @param string|null $dhcp_mode The DHCP mode options for the switch stack interface         ('dhcpDisabled', 'dhcpRelay' or 'dhcpServer')
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $dhcp_relay_server_ips The DHCP relay server IPs to which DHCP packets would get relayed for the switch stack interface
     *
     * @return self
     */
     ...
     *
     * @param string|null $dhcp_lease_time The DHCP lease time config for the dhcp server running on switch stack interface         ('30 minutes', '1 hour', '4 hours', '12 hours', '1 day' or '1 week')
     *
     * @return self
     */
     ...
     *
     * @param string|null $dns_nameservers_option The DHCP name server option for the dhcp server running on the switch stack interface         ('googlePublicDns', 'openDns' or 'custom')
     *
     * @return self
     */
     ...
     *
     * @param bool|null $boot_options_enabled Enable DHCP boot options to provide PXE boot options configs for the dhcp server running on the switch         stack interface
     *
     * @return self
     */
     ...
     *
     * @param string|null $boot_next_server The PXE boot server IP for the DHCP server running on the switch stack interface
     *
     * @return self
     */
     ...
     * Sets boot_file_name
     *
     * @param string|null $boot_file_name The PXE boot server file name for the DHCP server running on the switch stack interface
     *
     * @return self
     */
     ...
     * Sets dhcp_options
     *
     * @param \Meraki\Model\UpdateDeviceSwitchRoutingInterfaceDhcpRequestDhcpOptionsInner[]|null $dhcp_options Array of DHCP options consisting of code, type and value for the DHCP server running on the         switch stack interface
     *
     * @return self
     */
     ...
     *
     * @param \Meraki\Model\UpdateDeviceSwitchRoutingInterfaceDhcpRequestReservedIpRangesInner[]|null $reserved_ip_ranges Array of DHCP reserved IP assignments for the DHCP server running on the switch stack interface
     *
     * @return self
     */
     ...
     *
     * @param \Meraki\Model\UpdateDeviceSwitchRoutingInterfaceDhcpRequestFixedIpAssignmentsInner[]|null $fixed_ip_assignments Array of DHCP fixed IP assignments for the DHCP server running on the switch stack interface
     *
     * @return self
     */
