...
/**
 * UpdateOrganizationPolicyObjectRequest Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class UpdateOrganizationPolicyObjectRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateOrganizationPolicyObject_request';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Name of a policy object, unique within the organization (alphanumeric, space, dash, or underscore characters only)
     *
     * @return self
     */
