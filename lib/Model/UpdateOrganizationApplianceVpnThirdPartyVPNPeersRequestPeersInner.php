...
/**
 * UpdateOrganizationApplianceVpnThirdPartyVPNPeersRequestPeersInner Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class UpdateOrganizationApplianceVpnThirdPartyVPNPeersRequestPeersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateOrganizationApplianceVpnThirdPartyVPNPeers_request_peers_inner';
    ...
    protected static $setters = [
        ...
        'public_hostname' => 'setPublicHostname',
    ...
    protected static $getters = [
        ...
        'public_hostname' => 'getPublicHostname',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('public_hostname', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets public_hostname
     *
     * @return string|null
     */
    public function getPublicHostname()
    {
        return $this->container['public_hostname'];
    }

    /**
     * Sets public_hostname
     *
     * @param string|null $public_hostname [optional] The public hostname of the VPN peer
     *
     * @return self
     */
    public function setPublicHostname($public_hostname)
    {
        if (is_null($public_hostname)) {
            throw new \InvalidArgumentException('non-nullable public_hostname cannot be null');
        }
        $this->container['public_hostname'] = $public_hostname;
