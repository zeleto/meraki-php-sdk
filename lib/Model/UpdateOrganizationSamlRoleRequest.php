...
/**
 * UpdateOrganizationSamlRoleRequest Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class UpdateOrganizationSamlRoleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateOrganizationSamlRole_request';
    ...
    */
     ...
     * Sets org_access
     *
     * @param string|null $org_access The privilege of the SAML administrator on the organization. Can be one of 'none', 'read-only', 'full' or 'enterprise'
     *
     * @return self
     */
