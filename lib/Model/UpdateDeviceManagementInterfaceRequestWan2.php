...
/**
 * UpdateDeviceManagementInterfaceRequestWan2 Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateDeviceManagementInterfaceRequestWan2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateDeviceManagementInterface_request_wan2';
    ...
    public const WAN_ENABLED_DISABLED = 'disabled';
    public const WAN_ENABLED_ENABLED = 'enabled';
    public const WAN_ENABLED_NOT_CONFIGURED = 'not configured';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['wan_enabled']) && !in_array($this->container['wan_enabled'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'wan_enabled', must be one of '%s'",
                $this->container['wan_enabled'],
    ...
    public function setWanEnabled($wan_enabled)
    {
        ...
        $allowedValues = $this->getWanEnabledAllowableValues();
        if (!in_array($wan_enabled, $allowedValues, true)) {
