...
/**
 * GetNetworkSmDeviceDeviceProfiles200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class GetNetworkSmDeviceDeviceProfiles200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getNetworkSmDeviceDeviceProfiles_200_response_inner';
    ...
    protected static $setters = [
        ...
        'profile_identifier' => 'setProfileIdentifier',
        'name' => 'setName',
        'version' => 'setVersion'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('profile_identifier', $data ?? [], null);
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The numerical Meraki Id of the profile.
     *
     * @return self
     */
     ...
     * Sets is_encrypted
     *
     * @param bool|null $is_encrypted A boolean indicating if the profile is encrypted.
     *
     * @return self
     */
     ...
     * Sets is_managed
     *
     * @param bool|null $is_managed Whether or not the profile is managed by Meraki.
     *
     * @return self
     */
     ...
     * Sets profile_data
     *
     * @param string|null $profile_data A string containing a JSON object with the profile data.
     *
     * @return self
     */
    ...
    /**
     * Gets profile_identifier
     *
     * @return string|null
     */
    public function getProfileIdentifier()
    {
        return $this->container['profile_identifier'];
    }

    /**
     * Sets profile_identifier
     *
     * @param string|null $profile_identifier The identifier of the profile.
     *
     * @return self
     */
    public function setProfileIdentifier($profile_identifier)
    {
        if (is_null($profile_identifier)) {
            throw new \InvalidArgumentException('non-nullable profile_identifier cannot be null');
        }
        $this->container['profile_identifier'] = $profile_identifier;
     ...
     * Sets version
     *
     * @param string|null $version The verison of the profile.
     *
     * @return self
     */
