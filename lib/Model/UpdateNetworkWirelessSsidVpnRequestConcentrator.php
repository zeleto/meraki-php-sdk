...
/**
 * UpdateNetworkWirelessSsidVpnRequestConcentrator Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateNetworkWirelessSsidVpnRequestConcentrator implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateNetworkWirelessSsidVpn_request_concentrator';
    ...
    */
     ...
     * Sets network_id
     *
     * @param string|null $network_id The NAT ID of the concentrator that should be set.
     *
     * @return self
     */
     ...
     * Sets vlan_id
     *
     * @param int|null $vlan_id The VLAN that should be tagged for the concentrator.
     *
     * @return self
     */
