...
/**
 * UpdateNetworkGroupPolicyRequest Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class UpdateNetworkGroupPolicyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateNetworkGroupPolicy_request';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The name for your group policy.
     *
     * @return self
     */
