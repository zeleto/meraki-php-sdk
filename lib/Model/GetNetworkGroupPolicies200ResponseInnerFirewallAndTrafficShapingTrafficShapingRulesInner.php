...
/**
 * GetNetworkGroupPolicies200ResponseInnerFirewallAndTrafficShapingTrafficShapingRulesInner Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class GetNetworkGroupPolicies200ResponseInnerFirewallAndTrafficShapingTrafficShapingRulesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getNetworkGroupPolicies_200_response_inner_firewallAndTrafficShaping_trafficShapingRules_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('pcp_tag_value', $data ?? [], null);
    ...
    */
     ...
     * Sets pcp_tag_value
     *
     * @param int|null $pcp_tag_value The PCP tag applied by your rule. Can be 0 (lowest priority) through 7 (highest priority).     null means 'Do not set PCP tag'.
     *
     * @return self
     */
    public function setPcpTagValue($pcp_tag_value)
    {
        if (is_null($pcp_tag_value)) {
            throw new \InvalidArgumentException('non-nullable pcp_tag_value cannot be null');
        }
