...
/**
 * UpdateNetworkApplianceVlanRequest Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class UpdateNetworkApplianceVlanRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateNetworkApplianceVlan_request';
    ...
    protected static $openAPITypes = [
        ...
        'reserved_ip_ranges' => '\Meraki\Model\UpdateNetworkApplianceVlanRequestReservedIpRangesInner[]',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('template_vlan_type', $data ?? [], null);
    ...
    */
     ...
     *
     * @param object|null $fixed_ip_assignments The DHCP fixed IP assignments on the VLAN. This should be an object that contains mappings from MAC addresses to objects that themselves each contain \"ip\" and \"name\" string fields. See the sample request/response for more details.
     *
     * @return self
     */
     ...
     *
     * @return \Meraki\Model\UpdateNetworkApplianceVlanRequestReservedIpRangesInner[]|null
     */
     ...
     *
     * @param \Meraki\Model\UpdateNetworkApplianceVlanRequestReservedIpRangesInner[]|null $reserved_ip_ranges The DHCP reserved IP ranges on the VLAN
     *
     * @return self
     */
