<?php
/**
 * CreateNetworkCameraQualityRetentionProfileRequestVideoSettingsMV84X
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CreateNetworkCameraQualityRetentionProfileRequestVideoSettingsMV84X Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateNetworkCameraQualityRetentionProfileRequestVideoSettingsMV84X implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createNetworkCameraQualityRetentionProfile_request_videoSettings_MV84X';
    ...
    public const RESOLUTION__1440X1080 = '1440x1080';
    public const RESOLUTION__2560X1920 = '2560x1920';
    ...
    {
        return [
            self::RESOLUTION__1440X1080,
            self::RESOLUTION__2560X1920,
        ];
    }
    ...
    */
     ...
     * Sets quality
     *
     * @param string $quality Quality of the camera. Can be one of 'Standard' or 'Enhanced'.
     *
     * @return self
     */
     ...
     * Sets resolution
     *
     * @param string $resolution Resolution of the camera. Can be one of '1440x1080' or '2560x1920'.
     *
     * @return self
     */
