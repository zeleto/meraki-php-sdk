...
/**
 * WipeNetworkSmDevicesRequest Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class WipeNetworkSmDevicesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'wipeNetworkSmDevices_request';
    ...
    */
     ...
     * Sets wifi_mac
     *
     * @param string|null $wifi_mac The wifiMac of the device to be wiped.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id The id of the device to be wiped.
     *
     * @return self
     */
     ...
     * Sets serial
     *
     * @param string|null $serial The serial of the device to be wiped.
     *
     * @return self
     */
     ...
     * Sets pin
     *
     * @param int|null $pin The pin number (a six digit value) for wiping a macOS device. Required only for macOS devices.
     *
     * @return self
     */
