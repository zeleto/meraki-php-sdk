<?php
/**
 * DevicesSerialLiveToolsArpTablePostRequestMessageEntriesInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * DevicesSerialLiveToolsArpTablePostRequestMessageEntriesInner Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class DevicesSerialLiveToolsArpTablePostRequestMessageEntriesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_devices__serial__liveTools_arpTable_post_request_message_entries_inner';
    ...
    */
     ...
     * Sets ip
     *
     * @param string|null $ip The IP address of the ARP table entry
     *
     * @return self
     */
     ...
     * Sets mac
     *
     * @param string|null $mac The MAC address of the ARP table entry
     *
     * @return self
     */
     ...
     * Sets vlan_id
     *
     * @param int|null $vlan_id The VLAN ID of the ARP table entry
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $last_updated_at Time of the last update of the ARP table entry
     *
     * @return self
     */
