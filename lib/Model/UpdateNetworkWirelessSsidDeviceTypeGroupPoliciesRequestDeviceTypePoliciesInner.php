...
/**
 * UpdateNetworkWirelessSsidDeviceTypeGroupPoliciesRequestDeviceTypePoliciesInner Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class UpdateNetworkWirelessSsidDeviceTypeGroupPoliciesRequestDeviceTypePoliciesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateNetworkWirelessSsidDeviceTypeGroupPolicies_request_deviceTypePolicies_inner';
    ...
    public const DEVICE_TYPE_BN_NOOK = 'B&N Nook';
    public const DEVICE_TYPE_BLACK_BERRY = 'BlackBerry';
    public const DEVICE_TYPE_CHROME_OS = 'Chrome OS';
    public const DEVICE_TYPE_MAC_OS_X = 'Mac OS X';
    public const DEVICE_TYPE_OTHER_OS = 'Other OS';
    public const DEVICE_TYPE_WINDOWS = 'Windows';
    public const DEVICE_TYPE_WINDOWS_PHONE = 'Windows Phone';
    public const DEVICE_TYPE_I_PAD = 'iPad';
    public const DEVICE_TYPE_I_PHONE = 'iPhone';
    public const DEVICE_TYPE_I_POD = 'iPod';
    ...
    */
     ...
     *
     * @param int|null $group_policy_id ID of the group policy object.
     *
     * @return self
     */
