...
/**
 * GetOrganizationClientsOverview200ResponseUsageOverall Class Doc Comment
 *
 * @category Class
 ...
 */
class GetOrganizationClientsOverview200ResponseUsageOverall implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getOrganizationClientsOverview_200_response_usage_overall';
    ...
    */
     ...
     * Sets total
     *
     * @param float|null $total Total data usage (in kb) of all clients across organization
     *
     * @return self
     */
     ...
     * Sets downstream
     *
     * @param float|null $downstream Downstream data usage (in kb) of all clients across organization
     *
     * @return self
     */
     ...
     * Sets upstream
     *
     * @param float|null $upstream Upstream data usage (in kb) of all clients across organization
     *
     * @return self
     */
