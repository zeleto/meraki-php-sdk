...
/**
 * GetNetworkSwitchAccessControlLists200ResponseRulesInner Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class GetNetworkSwitchAccessControlLists200ResponseRulesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getNetworkSwitchAccessControlLists_200_response_rules_inner';
    ...
    */
     ...
     * Sets ip_version
     *
     * @param string|null $ip_version IP address version
     *
     * @return self
     */
     ...
     * Sets src_cidr
     *
     * @param string|null $src_cidr Source IP address (in IP or CIDR notation)
     *
     * @return self
     */
     ...
     * Sets dst_cidr
     *
     * @param string|null $dst_cidr Destination IP address (in IP or CIDR notation)
     *
     * @return self
     */
     ...
     * Sets vlan
     *
     * @param string|null $vlan ncoming traffic VLAN
     *
     * @return self
     */
