...
/**
 * DevicesSerialLiveToolsPingPostRequestMessageResultsRepliesInner Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class DevicesSerialLiveToolsPingPostRequestMessageResultsRepliesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_devices__serial__liveTools_ping_post_request_message_results_replies_inner';
    ...
    */
     ...
     * Sets sequence_id
     *
     * @param int|null $sequence_id Sequence ID of the packet
     *
     * @return self
     */
     ...
     * Sets size
     *
     * @param int|null $size Size of the packet in bytes
     *
     * @return self
     */
     ...
     * Sets latency
     *
     * @param float|null $latency Latency of the packet in milliseconds
     *
     * @return self
     */
