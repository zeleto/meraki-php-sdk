...
/**
 * GetOrganizationSummaryTopClientsByUsage200ResponseInnerUsage Class Doc Comment
 *
 * @category Class
 ...
 */
class GetOrganizationSummaryTopClientsByUsage200ResponseInnerUsage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getOrganizationSummaryTopClientsByUsage_200_response_inner_usage';
    ...
    */
     ...
     * Sets total
     *
     * @param float|null $total Total data usage by client
     *
     * @return self
     */
     ...
     * Sets upstream
     *
     * @param float|null $upstream Upstream data usage by client
     *
     * @return self
     */
     ...
     * Sets downstream
     *
     * @param float|null $downstream Downstream data usage by client
     *
     * @return self
     */
     ...
     * Sets percentage
     *
     * @param float|null $percentage Percentage of total data usage by client
     *
     * @return self
     */
