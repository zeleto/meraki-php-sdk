...
/**
 * CreateNetworkCameraWirelessProfileRequestSsid Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateNetworkCameraWirelessProfileRequestSsid implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createNetworkCameraWirelessProfile_request_ssid';
    ...
    */
     ...
     * Sets auth_mode
     *
     * @param string|null $auth_mode The auth mode of the SSID. It can be set to ('psk', '8021x-radius').
     *
     * @return self
     */
     ...
     *
     * @param string|null $encryption_mode The encryption mode of the SSID. It can be set to ('wpa', 'wpa-eap'). With 'wpa' mode, the authMode should be 'psk' and with 'wpa-eap' the authMode should be '8021x-radius'
     *
     * @return self
     */
     ...
     * Sets psk
     *
     * @param string|null $psk The pre-shared key of the SSID.
     *
     * @return self
     */
