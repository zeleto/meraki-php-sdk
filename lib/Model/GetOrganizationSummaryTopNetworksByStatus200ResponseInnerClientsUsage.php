<?php
/**
 * GetOrganizationSummaryTopNetworksByStatus200ResponseInnerClientsUsage
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetOrganizationSummaryTopNetworksByStatus200ResponseInnerClientsUsage Class Doc Comment
 *
 * @category Class
 ...
 */
class GetOrganizationSummaryTopNetworksByStatus200ResponseInnerClientsUsage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getOrganizationSummaryTopNetworksByStatus_200_response_inner_clients_usage';
    ...
    */
     ...
     * Sets upstream
     *
     * @param float|null $upstream Total upstream usage in network, in KB
     *
     * @return self
     */
     ...
     * Sets downstream
     *
     * @param float|null $downstream Total downstream usage in network, in KB
     *
     * @return self
     */
