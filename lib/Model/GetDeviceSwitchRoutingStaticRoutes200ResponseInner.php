...
/**
 * GetDeviceSwitchRoutingStaticRoutes200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class GetDeviceSwitchRoutingStaticRoutes200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getDeviceSwitchRoutingStaticRoutes_200_response_inner';
    ...
    protected static $setters = [
        'static_route_id' => 'setStaticRouteId',
        'name' => 'setName',
        'subnet' => 'setSubnet',
    ...
    protected static $getters = [
        'static_route_id' => 'getStaticRouteId',
        'name' => 'getName',
        'subnet' => 'getSubnet',
    ...
    {
        $this->setIfExists('static_route_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['static_route_id'] === null) {
            $invalidProperties[] = "'static_route_id' can't be null";
        }
    ...
    /**
     * Gets static_route_id
     *
     * @return string
     */
    public function getStaticRouteId()
    {
        return $this->container['static_route_id'];
    }

    /**
     * Sets static_route_id
     *
     * @param string $static_route_id The identifier of a layer 3 static route
     *
     * @return self
     */
    public function setStaticRouteId($static_route_id)
    {
        if (is_null($static_route_id)) {
            throw new \InvalidArgumentException('non-nullable static_route_id cannot be null');
        }
        $this->container['static_route_id'] = $static_route_id;
     ...
     * Sets name
     *
     * @param string|null $name The name or description of the layer 3 static route
     *
     * @return self
     */
     ...
     * Sets subnet
     *
     * @param string $subnet The IP address of the subnetwork specified in CIDR notation (ex. 1.2.3.0/24)
     *
     * @return self
     */
     ...
     * Sets next_hop_ip
     *
     * @param string $next_hop_ip The IP address of the router to which traffic for this destination network should be sent
     *
     * @return self
     */
     ...
     *
     * @param bool|null $advertise_via_ospf_enabled Option to advertise static routes via OSPF
     *
     * @return self
     */
     ...
     *
     * @param bool|null $prefer_over_ospf_routes_enabled Option to prefer static routes over OSPF routes
     *
     * @return self
     */
