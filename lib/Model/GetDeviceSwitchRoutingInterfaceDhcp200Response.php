...
/**
 * GetDeviceSwitchRoutingInterfaceDhcp200Response Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class GetDeviceSwitchRoutingInterfaceDhcp200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getDeviceSwitchRoutingInterfaceDhcp_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'dhcp_options' => '\Meraki\Model\GetDeviceSwitchRoutingInterfaceDhcp200ResponseDhcpOptionsInner[]',
        'reserved_ip_ranges' => '\Meraki\Model\GetDeviceSwitchRoutingInterfaceDhcp200ResponseReservedIpRangesInner[]',
        'fixed_ip_assignments' => '\Meraki\Model\GetDeviceSwitchRoutingInterfaceDhcp200ResponseFixedIpAssignmentsInner[]'
    ];
    ...
    */
     ...
     *
     * @param string|null $dhcp_lease_time The DHCP lease time config for the dhcp server running on the switch stack interface ('30 minutes', '1 hour', '4 hours', '12 hours', '1 day' or '1 week')
     *
     * @return self
     */
     ...
     * Gets dhcp_options
     *
     * @return \Meraki\Model\GetDeviceSwitchRoutingInterfaceDhcp200ResponseDhcpOptionsInner[]|null
     */
     ...
     * Sets dhcp_options
     *
     * @param \Meraki\Model\GetDeviceSwitchRoutingInterfaceDhcp200ResponseDhcpOptionsInner[]|null $dhcp_options Array of DHCP options consisting of code, type and value for the DHCP server running on the switch stack interface
     *
     * @return self
     */
     ...
     *
     * @return \Meraki\Model\GetDeviceSwitchRoutingInterfaceDhcp200ResponseReservedIpRangesInner[]|null
     */
     ...
     *
     * @param \Meraki\Model\GetDeviceSwitchRoutingInterfaceDhcp200ResponseReservedIpRangesInner[]|null $reserved_ip_ranges Array of DHCP reserved IP assignments for the DHCP server running on the switch stack interface
     *
     * @return self
     */
     ...
     *
     * @return \Meraki\Model\GetDeviceSwitchRoutingInterfaceDhcp200ResponseFixedIpAssignmentsInner[]|null
     */
     ...
     *
     * @param \Meraki\Model\GetDeviceSwitchRoutingInterfaceDhcp200ResponseFixedIpAssignmentsInner[]|null $fixed_ip_assignments Array of DHCP reserved IP assignments for the DHCP server running on the switch stack interface
     *
     * @return self
     */
