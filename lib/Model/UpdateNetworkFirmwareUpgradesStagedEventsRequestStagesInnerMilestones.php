...
/**
 * UpdateNetworkFirmwareUpgradesStagedEventsRequestStagesInnerMilestones Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateNetworkFirmwareUpgradesStagedEventsRequestStagesInnerMilestones implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateNetworkFirmwareUpgradesStagedEvents_request_stages_inner_milestones';
    ...
    */
     ...
     * Sets scheduled_for
     *
     * @param string $scheduled_for The start time of the staged upgrade stage. (In ISO-8601 format, in the time zone of the network.)
     *
     * @return self
     */
