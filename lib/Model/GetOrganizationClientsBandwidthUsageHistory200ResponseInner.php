...
/**
 * GetOrganizationClientsBandwidthUsageHistory200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class GetOrganizationClientsBandwidthUsageHistory200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getOrganizationClientsBandwidthUsageHistory_200_response_inner';
    ...
    */
     ...
     * Sets ts
     *
     * @param \DateTime|null $ts Timestamp for the bandwidth usage snapshot.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param int|null $total Total bandwidth usage, in mbps.
     *
     * @return self
     */
     ...
     * Sets upstream
     *
     * @param int|null $upstream Uploaded data, in mbps.
     *
     * @return self
     */
     ...
     * Sets downstream
     *
     * @param int|null $downstream Downloaded data, in mbps.
     *
     * @return self
     */
