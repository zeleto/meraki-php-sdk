...
/**
 * UpdateOrganizationActionBatchRequest Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class UpdateOrganizationActionBatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateOrganizationActionBatch_request';
    ...
    */
     ...
     * Sets confirmed
     *
     * @param bool|null $confirmed A boolean representing whether or not the batch has been confirmed. This property cannot be unset once it is true.
     *
     * @return self
     */
     ...
     * Sets synchronous
     *
     * @param bool|null $synchronous Set to true to force the batch to run synchronous. There can be at most 20 actions in synchronous batch.
     *
     * @return self
     */
