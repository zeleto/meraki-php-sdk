<?php
/**
 * GetNetworkSwitchRoutingOspf200ResponseAreasInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetNetworkSwitchRoutingOspf200ResponseAreasInner Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class GetNetworkSwitchRoutingOspf200ResponseAreasInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getNetworkSwitchRoutingOspf_200_response_areas_inner';
    ...
    public const AREA_TYPE_NORMAL = 'normal';
    public const AREA_TYPE_NSSA = 'nssa';
    public const AREA_TYPE_STUB = 'stub';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['area_type']) && !in_array($this->container['area_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'area_type', must be one of '%s'",
                $this->container['area_type'],
     ...
     * Sets area_id
     *
     * @param string|null $area_id OSPF area ID
     *
     * @return self
     */
     ...
     * Sets area_name
     *
     * @param string|null $area_name Name of the OSPF area
     *
     * @return self
     */
     ...
     * Sets area_type
     *
     * @param string|null $area_type Area types in OSPF. Must be one of: [\"normal\", \"stub\", \"nssa\"]
     *
     * @return self
     */
    public function setAreaType($area_type)
    {
        if (is_null($area_type)) {
            throw new \InvalidArgumentException('non-nullable area_type cannot be null');
        }
        $allowedValues = $this->getAreaTypeAllowableValues();
