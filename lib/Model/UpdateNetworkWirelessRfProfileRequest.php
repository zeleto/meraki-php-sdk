...
/**
 * UpdateNetworkWirelessRfProfileRequest Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class UpdateNetworkWirelessRfProfileRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateNetworkWirelessRfProfile_request';
    ...
    protected static $openAPITypes = [
        ...
        'ap_band_settings' => '\Meraki\Model\UpdateNetworkWirelessRfProfileRequestApBandSettings',
        'two_four_ghz_settings' => '\Meraki\Model\UpdateNetworkWirelessRfProfileRequestTwoFourGhzSettings',
        'five_ghz_settings' => '\Meraki\Model\UpdateNetworkWirelessRfProfileRequestFiveGhzSettings',
        'six_ghz_settings' => '\Meraki\Model\UpdateNetworkWirelessRfProfileRequestSixGhzSettings',
        'transmission' => '\Meraki\Model\GetNetworkWirelessRfProfiles200ResponseTransmission',
        'per_ssid_settings' => '\Meraki\Model\CreateNetworkWirelessRfProfileRequestPerSsidSettings',
        'flex_radios' => '\Meraki\Model\CreateNetworkWirelessRfProfileRequestFlexRadios'
    ];
    ...
    public const MIN_BITRATE_TYPE_BAND = 'band';
    public const MIN_BITRATE_TYPE_SSID = 'ssid';
    public const BAND_SELECTION_TYPE_AP = 'ap';
    public const BAND_SELECTION_TYPE_SSID = 'ssid';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('flex_radios', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['min_bitrate_type']) && !in_array($this->container['min_bitrate_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'min_bitrate_type', must be one of '%s'",
                $this->container['min_bitrate_type'],
        ...
        if (!is_null($this->container['band_selection_type']) && !in_array($this->container['band_selection_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'band_selection_type', must be one of '%s'",
                $this->container['band_selection_type'],
                implode("', '", $allowedValues)
            );
        }
     ...
     *
     * @param bool|null $client_balancing_enabled Steers client to best available access point. Can be either true or false.
     *
     * @return self
     */
     ...
     *
     * @param string|null $min_bitrate_type Minimum bitrate can be set to either 'band' or 'ssid'.
     *
     * @return self
     */
    public function setMinBitrateType($min_bitrate_type)
    {
        ...
        $allowedValues = $this->getMinBitrateTypeAllowableValues();
        if (!in_array($min_bitrate_type, $allowedValues, true)) {
     ...
     *
     * @param string|null $band_selection_type Band selection can be set to either 'ssid' or 'ap'.
     *
     * @return self
     */
     ...
     *
     * @return \Meraki\Model\UpdateNetworkWirelessRfProfileRequestApBandSettings|null
     */
     ...
     *
     * @param \Meraki\Model\UpdateNetworkWirelessRfProfileRequestApBandSettings|null $ap_band_settings ap_band_settings
     *
     * @return self
     */
     ...
     *
     * @return \Meraki\Model\UpdateNetworkWirelessRfProfileRequestTwoFourGhzSettings|null
     */
     ...
     *
     * @param \Meraki\Model\UpdateNetworkWirelessRfProfileRequestTwoFourGhzSettings|null $two_four_ghz_settings two_four_ghz_settings
     *
     * @return self
     */
     ...
     *
     * @return \Meraki\Model\UpdateNetworkWirelessRfProfileRequestFiveGhzSettings|null
     */
     ...
     *
     * @param \Meraki\Model\UpdateNetworkWirelessRfProfileRequestFiveGhzSettings|null $five_ghz_settings five_ghz_settings
     *
     * @return self
     */
     ...
     *
     * @return \Meraki\Model\UpdateNetworkWirelessRfProfileRequestSixGhzSettings|null
     */
     ...
     *
     * @param \Meraki\Model\UpdateNetworkWirelessRfProfileRequestSixGhzSettings|null $six_ghz_settings six_ghz_settings
     *
     * @return self
     */
     ...
     *
     * @return \Meraki\Model\CreateNetworkWirelessRfProfileRequestPerSsidSettings|null
     */
     ...
     *
     * @param \Meraki\Model\CreateNetworkWirelessRfProfileRequestPerSsidSettings|null $per_ssid_settings per_ssid_settings
     *
     * @return self
     */
     ...
     * Gets flex_radios
     *
     * @return \Meraki\Model\CreateNetworkWirelessRfProfileRequestFlexRadios|null
     */
    public function getFlexRadios()
    {
        return $this->container['flex_radios'];
    }

    /**
     * Sets flex_radios
     *
     * @param \Meraki\Model\CreateNetworkWirelessRfProfileRequestFlexRadios|null $flex_radios flex_radios
     *
     * @return self
     */
    public function setFlexRadios($flex_radios)
    {
        if (is_null($flex_radios)) {
            throw new \InvalidArgumentException('non-nullable flex_radios cannot be null');
        }
        $this->container['flex_radios'] = $flex_radios;
