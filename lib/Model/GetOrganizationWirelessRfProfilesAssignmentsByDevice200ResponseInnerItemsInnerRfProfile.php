<?php
/**
 * GetOrganizationWirelessRfProfilesAssignmentsByDevice200ResponseInnerItemsInnerRfProfile
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetOrganizationWirelessRfProfilesAssignmentsByDevice200ResponseInnerItemsInnerRfProfile Class Doc Comment
 *
 * @category Class
 ...
 */
class GetOrganizationWirelessRfProfilesAssignmentsByDevice200ResponseInnerItemsInnerRfProfile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getOrganizationWirelessRfProfilesAssignmentsByDevice_200_response_inner_items_inner_rfProfile';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The ID of the RF Profile the device belongs to.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of the RF Profile the device belongs to.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $is_indoor_default Status to show if this profile is default indoor profile.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $is_outdoor_default Status to show if this profile is default outdoor profile.
     *
     * @return self
     */
