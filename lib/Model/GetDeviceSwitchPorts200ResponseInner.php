...
/**
 * GetDeviceSwitchPorts200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class GetDeviceSwitchPorts200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getDeviceSwitchPorts_200_response_inner';
    ...
    protected static $openAPITypes = [
        ...
        'link_negotiation_capabilities' => 'string[]',
        'port_schedule_id' => 'string',
        'schedule' => '\Meraki\Model\GetDeviceSwitchPorts200ResponseInnerSchedule',
        'udld' => 'string',
        ...
        'adaptive_policy_group' => '\Meraki\Model\GetDeviceSwitchPorts200ResponseInnerAdaptivePolicyGroup',
        'peer_sgt_capable' => 'bool',
        'flexible_stacking_enabled' => 'bool',
        'dai_trusted' => 'bool',
        'profile' => '\Meraki\Model\GetDeviceSwitchPorts200ResponseInnerProfile',
        'module' => '\Meraki\Model\GetDeviceSwitchPorts200ResponseInnerModule',
        'mirror' => '\Meraki\Model\GetDeviceSwitchPorts200ResponseInnerMirror',
        'dot3az' => '\Meraki\Model\GetDeviceSwitchPorts200ResponseInnerDot3az',
        'stackwise_virtual' => '\Meraki\Model\GetDeviceSwitchPorts200ResponseInnerStackwiseVirtual'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'link_negotiation_capabilities' => null,
        ...
        'adaptive_policy_group_id' => null,
        'adaptive_policy_group' => null,
        'peer_sgt_capable' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'link_negotiation_capabilities' => false,
        ...
        'adaptive_policy_group_id' => false,
    ...
    protected static $attributeMap = [
        ...
        'mirror' => 'mirror',
        'dot3az' => 'dot3az',
        'stackwise_virtual' => 'stackwiseVirtual'
    ];
    ...
    protected static $setters = [
        ...
        'link_negotiation_capabilities' => 'setLinkNegotiationCapabilities',
        ...
        'adaptive_policy_group_id' => 'setAdaptivePolicyGroupId',
        'adaptive_policy_group' => 'setAdaptivePolicyGroup',
        'peer_sgt_capable' => 'setPeerSgtCapable',
        ...
        'mirror' => 'setMirror',
        'dot3az' => 'setDot3az',
        'stackwise_virtual' => 'setStackwiseVirtual'
    ];
    ...
    protected static $getters = [
        ...
        'link_negotiation_capabilities' => 'getLinkNegotiationCapabilities',
        ...
        'adaptive_policy_group_id' => 'getAdaptivePolicyGroupId',
        'adaptive_policy_group' => 'getAdaptivePolicyGroup',
        'peer_sgt_capable' => 'getPeerSgtCapable',
        ...
        'mirror' => 'getMirror',
        'dot3az' => 'getDot3az',
        'stackwise_virtual' => 'getStackwiseVirtual'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('link_negotiation_capabilities', $data ?? [], null);
        ...
        $this->setIfExists('adaptive_policy_group_id', $data ?? [], null);
        $this->setIfExists('adaptive_policy_group', $data ?? [], null);
        $this->setIfExists('peer_sgt_capable', $data ?? [], null);
        ...
        $this->setIfExists('stackwise_virtual', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param bool|null $isolation_enabled The isolation status of the switch port.
     *
     * @return self
     */
    ...
    /**
     * Gets link_negotiation_capabilities
     *
     * @return string[]|null
     */
    public function getLinkNegotiationCapabilities()
    {
        return $this->container['link_negotiation_capabilities'];
    }

    /**
     * Sets link_negotiation_capabilities
     *
     * @param string[]|null $link_negotiation_capabilities Available link speeds for the switch port.
     *
     * @return self
     */
    public function setLinkNegotiationCapabilities($link_negotiation_capabilities)
    {
        if (is_null($link_negotiation_capabilities)) {
            throw new \InvalidArgumentException('non-nullable link_negotiation_capabilities cannot be null');
        }
        $this->container['link_negotiation_capabilities'] = $link_negotiation_capabilities;
     ...
     * Gets schedule
     *
     * @return \Meraki\Model\GetDeviceSwitchPorts200ResponseInnerSchedule|null
     */
     ...
     * Sets schedule
     *
     * @param \Meraki\Model\GetDeviceSwitchPorts200ResponseInnerSchedule|null $schedule schedule
     *
     * @return self
     */
     ...
     *
     * @param int|null $access_policy_number The number of a custom access policy to configure on the switch port. Only applicable when 'accessPolicyType' is 'Custom access policy'.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $storm_control_enabled The storm control status of the switch port.
     *
     * @return self
     */
    ...
    /**
     * Gets adaptive_policy_group_id
     *
     * @return string|null
     */
    public function getAdaptivePolicyGroupId()
    {
        return $this->container['adaptive_policy_group_id'];
    }

    /**
     * Sets adaptive_policy_group_id
     *
     * @param string|null $adaptive_policy_group_id The adaptive policy group ID that will be used to tag traffic through this switch port. This ID must pre-exist during the configuration, else needs to be created using adaptivePolicy/groups API. Cannot be applied to a port on a switch bound to profile.
     *
     * @return self
     */
    public function setAdaptivePolicyGroupId($adaptive_policy_group_id)
    {
        if (is_null($adaptive_policy_group_id)) {
            throw new \InvalidArgumentException('non-nullable adaptive_policy_group_id cannot be null');
        }
        $this->container['adaptive_policy_group_id'] = $adaptive_policy_group_id;
     ...
     *
     * @return \Meraki\Model\GetDeviceSwitchPorts200ResponseInnerAdaptivePolicyGroup|null
     */
     ...
     *
     * @param \Meraki\Model\GetDeviceSwitchPorts200ResponseInnerAdaptivePolicyGroup|null $adaptive_policy_group adaptive_policy_group
     *
     * @return self
     */
    ...
    /**
     * Gets peer_sgt_capable
     *
     * @return bool|null
     */
    public function getPeerSgtCapable()
    {
        return $this->container['peer_sgt_capable'];
    }

    /**
     * Sets peer_sgt_capable
     *
     * @param bool|null $peer_sgt_capable If true, Peer SGT is enabled for traffic through this switch port. Applicable to trunk port only, not access port. Cannot be applied to a port on a switch bound to profile.
     *
     * @return self
     */
    public function setPeerSgtCapable($peer_sgt_capable)
    {
        if (is_null($peer_sgt_capable)) {
            throw new \InvalidArgumentException('non-nullable peer_sgt_capable cannot be null');
        }
        $this->container['peer_sgt_capable'] = $peer_sgt_capable;
     ...
     * Gets module
     *
     * @return \Meraki\Model\GetDeviceSwitchPorts200ResponseInnerModule|null
     */
     ...
     * Sets module
     *
     * @param \Meraki\Model\GetDeviceSwitchPorts200ResponseInnerModule|null $module module
     *
     * @return self
     */
     ...
     * Gets mirror
     *
     * @return \Meraki\Model\GetDeviceSwitchPorts200ResponseInnerMirror|null
     */
     ...
     * Sets mirror
     *
     * @param \Meraki\Model\GetDeviceSwitchPorts200ResponseInnerMirror|null $mirror mirror
     *
     * @return self
     */
     ...
     * Gets dot3az
     *
     * @return \Meraki\Model\GetDeviceSwitchPorts200ResponseInnerDot3az|null
     */
     ...
     * Sets dot3az
     *
     * @param \Meraki\Model\GetDeviceSwitchPorts200ResponseInnerDot3az|null $dot3az dot3az
     *
     * @return self
     */
    ...
    /**
     * Gets stackwise_virtual
     *
     * @return \Meraki\Model\GetDeviceSwitchPorts200ResponseInnerStackwiseVirtual|null
     */
    public function getStackwiseVirtual()
    {
        return $this->container['stackwise_virtual'];
    }

    /**
     * Sets stackwise_virtual
     *
     * @param \Meraki\Model\GetDeviceSwitchPorts200ResponseInnerStackwiseVirtual|null $stackwise_virtual stackwise_virtual
     *
     * @return self
     */
    public function setStackwiseVirtual($stackwise_virtual)
    {
        if (is_null($stackwise_virtual)) {
            throw new \InvalidArgumentException('non-nullable stackwise_virtual cannot be null');
        }
        $this->container['stackwise_virtual'] = $stackwise_virtual;
