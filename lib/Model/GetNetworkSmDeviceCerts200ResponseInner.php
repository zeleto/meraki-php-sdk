...
/**
 * GetNetworkSmDeviceCerts200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class GetNetworkSmDeviceCerts200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getNetworkSmDeviceCerts_200_response_inner';
    ...
    */
     ...
     *
     * @param string|null $not_valid_after The date after which the certificate is no longer valid.
     *
     * @return self
     */
     ...
     *
     * @param string|null $not_valid_before The date before which the certificate is not valid.
     *
     * @return self
     */
     ...
     * Sets cert_pem
     *
     * @param string|null $cert_pem The PEM of the certificate.
     *
     * @return self
     */
    ...
    {
        if (is_null($cert_pem)) {
            throw new \InvalidArgumentException('non-nullable cert_pem cannot be null');
        }
     ...
     * Sets issuer
     *
     * @param string|null $issuer The certificate issuer.
     *
     * @return self
     */
     ...
     * Sets subject
     *
     * @param string|null $subject The subject of the certificate.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id The Meraki Id of the certificate record.
     *
     * @return self
     */
