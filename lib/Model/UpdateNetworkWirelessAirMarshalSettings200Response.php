<?php
/**
 * UpdateNetworkWirelessAirMarshalSettings200Response
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * UpdateNetworkWirelessAirMarshalSettings200Response Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class UpdateNetworkWirelessAirMarshalSettings200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateNetworkWirelessAirMarshalSettings_200_response';
    ...
    */
     ...
     * Sets network_id
     *
     * @param string|null $network_id The network ID
     *
     * @return self
     */
     ...
     * Sets default_policy
     *
     * @param string|null $default_policy Indicates whether or not clients are allowed to       connect to rogue SSIDs. (blocked by default)
     *
     * @return self
     */
