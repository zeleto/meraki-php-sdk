<?php
/**
 * GetNetworkCellularGatewaySubnetPool200ResponseSubnetsInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetNetworkCellularGatewaySubnetPool200ResponseSubnetsInner Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class GetNetworkCellularGatewaySubnetPool200ResponseSubnetsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getNetworkCellularGatewaySubnetPool_200_response_subnets_inner';
    ...
    */
     ...
     * Sets serial
     *
     * @param string|null $serial Serial Number of the MG.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Name of the MG.
     *
     * @return self
     */
     ...
     * Sets appliance_ip
     *
     * @param string|null $appliance_ip Appliance IP of the MG device.
     *
     * @return self
     */
     ...
     * Sets subnet
     *
     * @param string|null $subnet Subnet of MG device.
     *
     * @return self
     */
