...
/**
 * CreateOrganizationInventoryDevicesSwapsBulk207ResponseSwapsInnerDevicesOld Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateOrganizationInventoryDevicesSwapsBulk207ResponseSwapsInnerDevicesOld implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createOrganizationInventoryDevicesSwapsBulk_207_response_swaps_inner_devices_old';
    ...
    */
     ...
     * Sets model
     *
     * @param string $model Model name for device
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Customized name for device, or MAC address
     *
     * @return self
     */
