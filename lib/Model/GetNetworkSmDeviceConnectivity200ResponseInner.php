...
/**
 * GetNetworkSmDeviceConnectivity200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class GetNetworkSmDeviceConnectivity200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getNetworkSmDeviceConnectivity_200_response_inner';
    ...
    */
     ...
     * Sets first_seen_at
     *
     * @param string|null $first_seen_at When the device was first seen as connected to the internet in each connection.
     *
     * @return self
     */
     ...
     * Sets last_seen_at
     *
     * @param string|null $last_seen_at When the device was last seen as connected to the internet in each connection.
     *
     * @return self
     */
