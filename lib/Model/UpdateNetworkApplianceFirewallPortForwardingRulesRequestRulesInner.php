...
/**
 * UpdateNetworkApplianceFirewallPortForwardingRulesRequestRulesInner Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class UpdateNetworkApplianceFirewallPortForwardingRulesRequestRulesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateNetworkApplianceFirewallPortForwardingRules_request_rules_inner';
    ...
    */
     ...
     * Sets uplink
     *
     * @param string|null $uplink The physical WAN interface on which the traffic will arrive ('internet1' or, if available, 'internet2' or 'both')
     *
     * @return self
     */
