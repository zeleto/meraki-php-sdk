...
/**
 * UpdateNetworkApplianceFirewallOneToManyNatRulesRequestRulesInnerPortRulesInner Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class UpdateNetworkApplianceFirewallOneToManyNatRulesRequestRulesInnerPortRulesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateNetworkApplianceFirewallOneToManyNatRules_request_rules_inner_portRules_inner';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name A description of the rule
     *
     * @return self
     */
     ...
     * Sets protocol
     *
     * @param string|null $protocol 'tcp' or 'udp'
     *
     * @return self
     */
     ...
     * Sets public_port
     *
     * @param string|null $public_port Destination port of the traffic that is arriving on the WAN
     *
     * @return self
     */
     ...
     * Sets local_ip
     *
     * @param string|null $local_ip Local IP address to which traffic will be forwarded
     *
     * @return self
     */
     ...
     * Sets local_port
     *
     * @param string|null $local_port Destination port of the forwarded traffic that will be sent from the MX to the specified host on the LAN. If you simply wish to forward the traffic without translating the port, this should be the same as the Public port
     *
     * @return self
     */
     ...
     * Sets allowed_ips
     *
     * @param string[]|null $allowed_ips Remote IP addresses or ranges that are permitted to access the internal resource via this port forwarding rule, or 'any'
     *
     * @return self
     */
