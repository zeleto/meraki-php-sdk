...
/**
 * GetNetworkGroupPolicies200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class GetNetworkGroupPolicies200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getNetworkGroupPolicies_200_response_inner';
    ...
    */
     ...
     *
     * @param string|null $group_policy_id The ID of the group policy
     *
     * @return self
     */
