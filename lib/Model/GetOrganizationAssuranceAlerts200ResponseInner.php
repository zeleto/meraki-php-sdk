...
/**
 * GetOrganizationAssuranceAlerts200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class GetOrganizationAssuranceAlerts200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getOrganizationAssuranceAlerts_200_response_inner';
    ...
    protected static $openAPITypes = [
        ...
        'network' => '\Meraki\Model\GetOrganizationAssuranceAlerts200ResponseInnerNetwork',
        'started_at' => '\DateTime',
        ...
        'description' => 'string',
        'severity' => 'string',
        'scope' => '\Meraki\Model\GetOrganizationAssuranceAlerts200ResponseInnerScope'
    ];
    ...
    */
     ...
     * Sets id
     *
     * @param string $id ID of the health alert
     *
     * @return self
     */
     ...
     * Sets category_type
     *
     * @param string $category_type Category type that the health alert belongs to
     *
     * @return self
     */
     ...
     * Gets network
     *
     * @return \Meraki\Model\GetOrganizationAssuranceAlerts200ResponseInnerNetwork
     */
     ...
     * Sets network
     *
     * @param \Meraki\Model\GetOrganizationAssuranceAlerts200ResponseInnerNetwork $network network
     *
     * @return self
     */
     ...
     * Sets started_at
     *
     * @param \DateTime $started_at Time when the alert started
     *
     * @return self
     */
     ...
     * Sets resolved_at
     *
     * @param \DateTime|null $resolved_at Time when the alert was resolved
     *
     * @return self
     */
     ...
     * Sets dismissed_at
     *
     * @param \DateTime|null $dismissed_at Time when the alert was dismissed
     *
     * @return self
     */
     ...
     * Sets device_type
     *
     * @param string|null $device_type Device Type that the alert occurred on
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string $title Human Readable Title for Alert type
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Description of the alert
     *
     * @return self
     */
     ...
     * Gets scope
     *
     * @return \Meraki\Model\GetOrganizationAssuranceAlerts200ResponseInnerScope|null
     */
     ...
     * Sets scope
     *
     * @param \Meraki\Model\GetOrganizationAssuranceAlerts200ResponseInnerScope|null $scope scope
     *
     * @return self
     */
