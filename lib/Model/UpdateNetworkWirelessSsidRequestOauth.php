...
/**
 * UpdateNetworkWirelessSsidRequestOauth Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateNetworkWirelessSsidRequestOauth implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateNetworkWirelessSsid_request_oauth';
    ...
    */
     ...
     *
     * @param string[]|null $allowed_domains (Optional) The list of domains allowed access to the network.
     *
     * @return self
     */
