...
/**
 * UpdateDeviceSwitchRoutingInterfaceRequest Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class UpdateDeviceSwitchRoutingInterfaceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateDeviceSwitchRoutingInterface_request';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name A friendly name or description for the interface or VLAN.
     *
     * @return self
     */
