...
/**
 * GetNetworkClientsBandwidthUsageHistory200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class GetNetworkClientsBandwidthUsageHistory200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getNetworkClientsBandwidthUsageHistory_200_response_inner';
    ...
    */
     ...
     * Sets ts
     *
     * @param \DateTime|null $ts The timestamp
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param float|null $total The total traffic over a time range for clients on a network
     *
     * @return self
     */
     ...
     * Sets upstream
     *
     * @param float|null $upstream The upstream traffic over a time range for clients on a network
     *
     * @return self
     */
     ...
     * Sets downstream
     *
     * @param float|null $downstream The downstream traffic over a time range for clients on a network
     *
     * @return self
     */
