...
/**
 * UpdateNetworkWirelessSsidRequestDnsRewrite Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateNetworkWirelessSsidRequestDnsRewrite implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateNetworkWirelessSsid_request_dnsRewrite';
    ...
    */
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Boolean indicating whether or not DNS server rewrite is enabled. If disabled, upstream DNS will be used
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $dns_custom_nameservers User specified DNS servers (up to two servers)
     *
     * @return self
     */
