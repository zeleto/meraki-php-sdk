...
/**
 * UpdateNetworkSwitchRoutingOspfRequestAreasInner Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class UpdateNetworkSwitchRoutingOspfRequestAreasInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateNetworkSwitchRoutingOspf_request_areas_inner';
    ...
    */
     ...
     * Sets area_id
     *
     * @param string $area_id OSPF area ID
     *
     * @return self
     */
