...
/**
 * GetDeviceCellularGatewayPortForwardingRules200ResponseRulesInner Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class GetDeviceCellularGatewayPortForwardingRules200ResponseRulesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getDeviceCellularGatewayPortForwardingRules_200_response_rules_inner';
    ...
    */
     ...
     * Sets lan_ip
     *
     * @param string|null $lan_ip The IP address of the server or device that hosts the internal resource that you wish to make available on the WAN
     *
     * @return self
     */
     ...
     * Sets public_port
     *
     * @param string|null $public_port A port or port ranges that will be forwarded to the host on the LAN
     *
     * @return self
     */
     ...
     * Sets local_port
     *
     * @param string|null $local_port A port or port ranges that will receive the forwarded traffic from the WAN
     *
     * @return self
     */
     ...
     * Sets access
     *
     * @param string|null $access `any` or `restricted`. Specify the right to make inbound connections on the specified ports or port ranges. If `restricted`, a list of allowed IPs is mandatory.
     *
     * @return self
     */
