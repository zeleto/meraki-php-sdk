...
/**
 * GetNetworkSwitchQosRules200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  Meraki
 * @author   OpenAPI Generator team
 ...
 */
class GetNetworkSwitchQosRules200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getNetworkSwitchQosRules_200_response_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Qos Rule id
     *
     * @return self
     */
     ...
     * Sets vlan
     *
     * @param int|null $vlan The VLAN of the incoming packet. A null value will match any VLAN.
     *
     * @return self
     */
     ...
     * Sets protocol
     *
     * @param string|null $protocol The protocol of the incoming packet. Can be one of \"ANY\", \"TCP\" or \"UDP\". Default value is \"ANY\"
     *
     * @return self
     */
     ...
     * Sets src_port_range
     *
     * @param string|null $src_port_range The source port range of the incoming packet. Applicable only if protocol is set to TCP or UDP. Example: 70-80
     *
     * @return self
     */
     ...
     * Sets dst_port_range
     *
     * @param string|null $dst_port_range The destination port range of the incoming packet. Applicable only if protocol is set to TCP or UDP. Example: 70-80
     *
     * @return self
     */
