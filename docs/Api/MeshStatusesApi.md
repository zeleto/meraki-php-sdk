...
$apiInstance = new Meraki\Api\MeshStatusesApi(
...
try {
    ...
    echo 'Exception when calling MeshStatusesApi->getNetworkWirelessMeshStatuses: ', $e->getMessage(), PHP_EOL;
}
```
