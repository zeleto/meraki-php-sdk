...
$apiInstance = new Meraki\Api\PerformanceHistoryApi(
...
try {
    ...
    echo 'Exception when calling PerformanceHistoryApi->getNetworkSmDevicePerformanceHistory: ', $e->getMessage(), PHP_EOL;
}
```
