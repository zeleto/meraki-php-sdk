...
$apiInstance = new Meraki\Api\DscpTaggingOptionsApi(
...
try {
    ...
    echo 'Exception when calling DscpTaggingOptionsApi->getNetworkTrafficShapingDscpTaggingOptions: ', $e->getMessage(), PHP_EOL;
}
```
