...
$apiInstance = new Meraki\Api\RedundancyApi(
...
try {
    ...
    echo 'Exception when calling RedundancyApi->getOrganizationWirelessControllerDevicesRedundancyFailoverHistory: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling RedundancyApi->getOrganizationWirelessControllerDevicesRedundancyStatuses: ', $e->getMessage(), PHP_EOL;
}
```
