# Meraki\ObjectDetectionModelsApi
...
$apiInstance = new Meraki\Api\ObjectDetectionModelsApi(
...
try {
    ...
    echo 'Exception when calling ObjectDetectionModelsApi->getDeviceCameraSenseObjectDetectionModels: ', $e->getMessage(), PHP_EOL;
}
```
