...
$apiInstance = new Meraki\Api\UtilizationApi(
...
try {
    ...
    echo 'Exception when calling UtilizationApi->getOrganizationWirelessControllerDevicesSystemUtilizationHistoryByInterval: ', $e->getMessage(), PHP_EOL;
}
```
