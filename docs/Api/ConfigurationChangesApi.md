# Meraki\ConfigurationChangesApi
...
$apiInstance = new Meraki\Api\ConfigurationChangesApi(
...
try {
    ...
    echo 'Exception when calling ConfigurationChangesApi->getOrganizationConfigurationChanges: ', $e->getMessage(), PHP_EOL;
}
```
