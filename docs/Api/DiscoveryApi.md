...
$apiInstance = new Meraki\Api\DiscoveryApi(
...
try {
    ...
    echo 'Exception when calling DiscoveryApi->getOrganizationSwitchPortsTopologyDiscoveryByDevice: ', $e->getMessage(), PHP_EOL;
}
```
