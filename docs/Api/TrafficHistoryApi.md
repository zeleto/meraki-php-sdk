...
$apiInstance = new Meraki\Api\TrafficHistoryApi(
...
try {
    ...
    echo 'Exception when calling TrafficHistoryApi->getNetworkClientTrafficHistory: ', $e->getMessage(), PHP_EOL;
}
```
