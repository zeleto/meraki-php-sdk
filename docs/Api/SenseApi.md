...
$apiInstance = new Meraki\Api\SenseApi(
...
try {
    ...
    echo 'Exception when calling SenseApi->getDeviceCameraSense: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling SenseApi->getDeviceCameraSenseObjectDetectionModels: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling SenseApi->updateDeviceCameraSense: ', $e->getMessage(), PHP_EOL;
}
```
