...
$apiInstance = new Meraki\Api\ByUtilizationApi(
...
try {
    ...
    echo 'Exception when calling ByUtilizationApi->getOrganizationSummaryTopAppliancesByUtilization: ', $e->getMessage(), PHP_EOL;
}
```
