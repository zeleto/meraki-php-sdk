...
$apiInstance = new Meraki\Api\BySwitchApi(
...
try {
    ...
    echo 'Exception when calling BySwitchApi->getOrganizationSwitchPortsBySwitch: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling BySwitchApi->getOrganizationSwitchPortsStatusesBySwitch: ', $e->getMessage(), PHP_EOL;
}
```
