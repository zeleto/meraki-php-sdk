# Meraki\ApplicationCategoriesApi
...
$apiInstance = new Meraki\Api\ApplicationCategoriesApi(
...
try {
    ...
    echo 'Exception when calling ApplicationCategoriesApi->getNetworkApplianceFirewallL7FirewallRulesApplicationCategories: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ApplicationCategoriesApi->getNetworkTrafficShapingApplicationCategories: ', $e->getMessage(), PHP_EOL;
}
```
