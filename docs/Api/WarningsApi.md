...
$apiInstance = new Meraki\Api\WarningsApi(
...
try {
    ...
    echo 'Exception when calling WarningsApi->getNetworkSwitchDhcpServerPolicyArpInspectionWarningsByDevice: ', $e->getMessage(), PHP_EOL;
}
```
