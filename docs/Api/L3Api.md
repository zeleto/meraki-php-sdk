...
$apiInstance = new Meraki\Api\L3Api(
...
try {
    ...
    echo 'Exception when calling L3Api->getOrganizationWirelessControllerDevicesInterfacesL3ByDevice: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling L3Api->getOrganizationWirelessControllerDevicesInterfacesL3StatusesChangeHistoryByDevice: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling L3Api->getOrganizationWirelessControllerDevicesInterfacesL3UsageHistoryByInterval: ', $e->getMessage(), PHP_EOL;
}
```
