...
$apiInstance = new Meraki\Api\SystemApi(
...
try {
    ...
    echo 'Exception when calling SystemApi->getOrganizationDevicesSystemMemoryUsageHistoryByInterval: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling SystemApi->getOrganizationWirelessControllerDevicesSystemUtilizationHistoryByInterval: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling SystemApi->getOrganizationWirelessDevicesSystemCpuLoadHistory: ', $e->getMessage(), PHP_EOL;
}
```
