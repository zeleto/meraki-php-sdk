...
$apiInstance = new Meraki\Api\SecurityCentersApi(
...
try {
    ...
    echo 'Exception when calling SecurityCentersApi->getNetworkSmDeviceSecurityCenters: ', $e->getMessage(), PHP_EOL;
}
```
