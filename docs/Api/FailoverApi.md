...
$apiInstance = new Meraki\Api\FailoverApi(
...
try {
    ...
    echo 'Exception when calling FailoverApi->getOrganizationWirelessControllerDevicesRedundancyFailoverHistory: ', $e->getMessage(), PHP_EOL;
}
```
