...
$apiInstance = new Meraki\Api\ApplicationUsageApi(
...
try {
    ...
    echo 'Exception when calling ApplicationUsageApi->getNetworkClientsApplicationUsage: ', $e->getMessage(), PHP_EOL;
}
```
