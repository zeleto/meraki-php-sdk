# Meraki\TrustedAccessConfigsApi
...
$apiInstance = new Meraki\Api\TrustedAccessConfigsApi(
...
try {
    ...
    echo 'Exception when calling TrustedAccessConfigsApi->getNetworkSmTrustedAccessConfigs: ', $e->getMessage(), PHP_EOL;
}
```
